...
export const ui = {
  nl: {
    ...
    'hero.subtitle': 'Gratis openluchtbioscoop in het Nelson Mandelapark',
    ...
    // Footer
    'footer.madeWith': 'Gemaakt met ❤️ voor de buurt',
  ...
  en: {
    ...
    // Hero
    'hero.title': 'Nelsons Film',
    'hero.subtitle': 'Free outdoor cinema in Nelson Mandela Park',
    ...
    // Footer
    'footer.madeWith': 'Made with ❤️ for the neighborhood',
    'footer.sponsors': 'Sponsors',
